...
// use super::{HasScopes, ScopesPolicy};
...
//     async fn verify_token<T: for<'de> Deserialize<'de> + HasScopes>(
//         &self,
//         token: &JwtRef,
//         policy: &ScopesPolicy,
//     ) -> anyhow::Result<T> {
...
//         let both = Scopes::from_scopes(vec![
//             Scope::new("testing"),
//             Scope::new("other"),
//         ]);

//         let t = Scopes::from_scopes(vec![Scope::new("testing")]);
